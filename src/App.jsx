...
const commissions = [
  {
    ...
    emoji: "🎨",
    variant: [
      { label: "Simple BG", price: 100000, desc: "Gambar karakter dengan background sederhana." },
      { label: "Normal BG", price: 130000, desc: "Gambar karakter dengan normal background." }, 
    ],
    slots: 5,
  },
  {
    ...
    emoji: "🐻‍❄️",
    variant: [
      { label: "Simple BG", price: 200000, desc: "Gambar karakter dengan background sederhana." },
      { label: "Normal BG", price: 250000, desc: "Gambar karakter dengan normal background." }, 
    ],
    slots: 3,
  },
  {
    ...
    emoji: "✨",
    variant: [
      { label: "Simple BG", price: 300000, desc: "Gambar karakter dengan background sederhana." },
      { label: "Normal BG", price: 380000, desc: "Gambar karakter dengan normal background." }, 
    ],
    slots: 2,
  },
];
...
const portfolio = [
  { 
    id: 1, 
    label: "Bust Up", 
    imgs: ["/Illustration29.jpg", "/mike kowalski.5.jpg", "/Ilustrasi.jpg", "/8d33286e_original.jpg", "/Illustration42.png"] 
  },
  { 
    id: 2, 
    label: "Half Body", 
    imgs: ["/Illustration64.png", "/Illustration41.png", "/Illustration32.jpg", "/ryugamine ichigo commission.jpg", "/Illustration31.jpg", "/raoo5325.jpg", "/Illustration35.jpg", "/160723-2.jpg", "/1NewCanvas11.jpg", "/commis shiro6.jpg"] 
  },
  { 
    id: 3, 
    label: "Full Body", 
    imgs: ["/Illustration58.png", "/Illustration51.png", "/Ilustrasicmmc06524.1-1.jpg", "/Illustration45.png", "/Illustration11.jpg", "/puppy0 (1).jpg"] 
  },
];
...
async function handleSubmit(e) {
  ...
  const webhookUrl = "https://discord.com/api/webhooks/1508346926934917262/hGuyRQRUUYE00d7je0g4WTmO3AYOJ9GeKicy6bVxBGikoN8i6RUTeafSbUDH-qxImWpV";
...
`;
        ...
        {activeTab === "home" && (
          <div style={styles.page}>
            <div style={styles.hero}>
              <img src="/lv_0_20250116221257.gif" style={{width: 100, height: 100, borderRadius: "100%", objectFit: "cover"}} />
            ...
            <div style={styles.infoGrid}>
              {[
                ...
                { icon: "💳", label: "Pembayaran", value: "Transfer Bank / E-WALLET" },
      ...
      {portfolio.map((kategori) => (
        <button
          ...
          style={{
            ...
            background: selectedCategory === kategori.id ? pink : "transparent",
        ...
        {activeTab === "commission" && (
          <div style={styles.page}>
            ...
            <h3 style={styles.sectionDesc}>
              Original character, personal use, commercial use, profile picture, banner, gift for friends, etc.
            </h3>
  ...
  <div key={c.id} style={styles.commCard}>
    ...
    {selectedComm === c.id ? (
      <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 8 }}>
        {c.variant.map((v) => (
          <button
            ...
            onClick={() => {
              setFormData({ ...formData, type: `${c.type} — ${v.label}` });
              setActiveTab("order");
              setSelectedComm(null);
            }}
          >
            <strong>{v.label}</strong>
            <span style={{ fontSize: 12, color: "#a06080" }}> · Rp {v.price.toLocaleString("id-ID")}</span>
            <div style={{ fontSize: 11, color: "#888", marginTop: 2 }}>{v.desc}</div>
          </button>
        ))}
        <button
          style={{ ...styles.btnSecondary, fontSize: 13, padding: "6px 12px" }}
      ...
      <button
        style={c.slots > 0 ? styles.btnPrimary : styles.btnDisabled}
        disabled={c.slots === 0}
        ...
        {c.slots > 0 ? "Pilih Commission" : "Slot Penuh"}
          ...
          <div style={styles.tos}>
            ...
            <ul style={styles.tosList}>
              <li><strong>Extra character</strong> — +50% per karakter</li>
              <li><strong>Detailed BG</strong> — +Rp 50.000 – 100.000</li>
              <li><strong>Commercial use</strong> — 2× total harga</li>
              <li>
                <strong>Character Design</strong> — Rp 500.000 – 1.000.000
                <ul style={{ marginTop: 4 }}>
                  <li><em>Basic</em> — 1 fullbody pose, final colour</li>
                  <li><em>Full</em> — 1 fullbody pose, outfit details, color palette</li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div style={styles.page}>
            ...
            {submitted ? (
              ...
              <div style={styles.successBox}>
                ...
                <p>
                  Aku akan balas dalam 1×24 jam ya. Cek DM atau email kamu!
                </p>
              ...
              <form onSubmit={handleSubmit} style={styles.form}>
                ...
                <div style={styles.formGroup}>
  <label style={styles.label}>Kontak Diskusi (Discord / Instagram / WA / FB / dll)</label>
  <input
    style={styles.input}
    type="text"
    name="contact"
...
<div style={styles.formGroup}>
  <label style={styles.label}>Email (untuk pengiriman file HD)</label>
  <input
    style={styles.input}
    type="email"
    name="email"
  ...
  />
                ...
                <div style={styles.formGroup}>
                  ...
                  >
                    ...
                    {commissions.map((c) =>
  c.variant.map((v) => (
    <option key={`${c.id}-${v.label}`} value={`${c.type} — ${v.label}`}>
      ...
      {c.slots === 0 ? " (FULL)" : ""}
                ...
                <div style={styles.formGroup}>
                  <label style={styles.label}>Deskripsi Karakter & Request</label>
...
const styles = {
  ...
  commDesc: { margin: 0, fontSize: 13, color: "#6b4060", lineHeight: 1.5, flex: 1 },
